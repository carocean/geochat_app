...
class BallisticIndicatorNestedScrollView extends StatefulWidget {
  ...
  @override
  State<BallisticIndicatorNestedScrollView> createState() => _BallisticIndicatorNestedScrollViewState();
}

class _BallisticIndicatorNestedScrollViewState extends BallisticIndicatorLayout<BallisticIndicatorNestedScrollView> {
  ...
  void initState() {
    ...
    indicatorSettings.scrollController?.addListener(() {
      _nestedScrollController?.jumpTo(indicatorSettings.scrollController?.offset??0.0);
    });
          ...
          child: ConstrainedBox(
            constraints: BoxConstraints(
              minHeight: scrollViewHeight(
                  widget.appBar?.collapsedHeight ?? 24, widget.navBarHeight ?? 0.0,
